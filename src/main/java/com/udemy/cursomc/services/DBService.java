...
import com.udemy.cursomc.repository.CategoriaRepository;
import com.udemy.cursomc.repository.CidadeRepository;
import com.udemy.cursomc.repository.ClienteRepository;
import com.udemy.cursomc.repository.EnderecoRepository;
import com.udemy.cursomc.repository.EstadoRepository;
...
import com.udemy.cursomc.repository.ProdutoRepository;
...
public class DBService {
	...
	public void instatiateTestDataBase() throws ParseException {
			...
			Cliente cli1 = new Cliente(null, "Maria Silva", "guilherme.230308@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
			cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

			Cliente cli2 = new Cliente(null, "Ana Costa", "guilherme_230308@hotmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
			cli2.getTelefones().addAll(Arrays.asList("67767876", "987673423"));
			cli2.addPerfil(Perfil.ADMIN);
			
			Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
			Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
			Endereco e3 = new Endereco(null, "Avenida Floriano", "456", null, "Centro", "356754895", cli2, c2);
